...
(autoload 'sql-mode "sql" "SQL Edit mode" nil t)
(autoload 'sql-oracle "sql" "SQL Edit mode" nil t)
(autoload 'sql-ms "sql" "SQL Edit mode" nil t)
(autoload 'master-mode "master" "Master mode minor mode." nil t)
...
(defvar sql-indent-maybe-tab "")
(defvar sql-pop-to-buffer-after-send-region "")
(defvar sql-buffer "")
(defvar sql-electric-stuff "")
...
(add-hook 'sql-mode-hook
          '(lambda ()
            (local-set-key "\C-t" 'sql-indent-maybe-tab)))
